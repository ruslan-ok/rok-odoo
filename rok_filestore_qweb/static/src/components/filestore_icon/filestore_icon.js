...
export default class FilestoreIcon extends Component {
    static template = "rok_filestore_qweb.FilestoreIcon";
    static props = {
        record: Object,
        readonly: Boolean,
...
class FilestoreIconField extends FilestoreIcon {
    static props = {
        ...standardFieldProps,
...
registry.category("fields").add("filestore_icon", {
    component: FilestoreIconField,
