...
import { FilestoreSidebar } from '@rok_filestore_qweb/components/sidebar/sidebar';
...
export class FilestoreFormController extends FormController {
    static template = "rok_filestore_qweb.FilestoreFormView";
    static components = {
        ...
        */
        ...
        onWillStart(() => {
            if (
                ...
                // this.filestoreCommandsService.unregisterCommandsRecordInfo(this.env.config.breadcrumbs);
            }
        });
        onMounted(() => {
