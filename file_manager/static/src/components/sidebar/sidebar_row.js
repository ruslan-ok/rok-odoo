...
class FileManagerSidebarIcon extends  FileManagerIcon {
    static props = {
        folder: Object,
        readonly: Boolean,
        record: Object,
    ...
    async updateIcon(icon) {
        if (this.props.record.resId === this.props.folder.id) {
            ...
            await this.orm.write(
                "file_manager.rok_ilestore_folder",
...
export class FileManagerSidebarRow extends Component {
    static props = {
        folder: Object,
        unfolded: Boolean,
        unfoldedIds: Set,
    ...
    static template = "file_manager.SidebarRow";
    static components = {
        FileManagerSidebarIcon,
